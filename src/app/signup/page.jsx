  ...
  return (
    <div className="isolate  bg-dark px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-white-900 sm:text-4xl">Create Account</h2>
      ...
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <label htmlFor="company" className="block text-sm font-semibold leading-6 text-white-900">
              Company
            </label>
            <div className="mt-2.5">
              <input
          ...
          <div className="sm:col-span-2">
            ...
            <label htmlFor="email" className="block text-sm font-semibold leading-6 text-white-900 mt-4">
              Password
            </label>
            <div className="mt-2.5">
              <input
